...
- **[Module 10: Game Design Frameworks & Documentation](module-10-game-design-frameworks-documentation.md)** — The one-page design document introduced here is just the beginning. Module 10 covers comprehensive design documentation, communication frameworks, and how to structure your design thinking for larger projects.
- **[Module 9: UX & Accessibility in Games](module-09-ux-accessibility-games.md)** — Playtesting reveals UX problems before they reach code. Module 9 teaches you to think about player experience systematically, including accessibility considerations that paper prototyping can surface early.
