...
The "mute test" is your first tool: play any polished game on mute for two minutes, then unmute. The gap between those two experiences is the entire value of sound design. That gap is what this roadmap teaches you to create. If you've worked through the [Game Design Theory roadmap's Module 9 on aesthetics and juice](../game-design-theory/module-09-aesthetics-feel-juice.md), you already know that audio is the single highest-impact layer of game feel. This roadmap is where you learn to build that layer yourself.
