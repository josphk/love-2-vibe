...
local defaults = {
    ...
    mask_strength = 0.45, pixel_size = 3,
    enable_grain = 1, grain_strength = 0.25,
    enable_curving = 0, curve_power = 1.02,
    enable_scanlines = 1, scanlines_interval = 3,
    scanlines_opacity = 0.45, scanlines_thickness = 1,
    enable_smearing = 0, smearing_strength = 0.2,
    enable_wiggle = 0, wiggle = 0.04,
    blur_radius = 2,
    bloom_threshold = 0.30, bloom_intensity = 0.7,
}
